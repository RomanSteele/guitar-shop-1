...
function SingleCatalogueCard( {card}: SingleCatalogueCardProps): JSX.Element {
  ...
  return (
    <div className="product-card">
      <img src={previewImg} srcSet="img/content/catalog-product-1@2x.jpg 2x" width="75" height="190" alt={name}/>
      ...
      <div className="product-card__buttons"><Link className="button button--mini" to="#">Подробнее</Link><Link className="button button--red-border button--mini button--in-cart" to="#">В Корзине</Link>
      </div>
    </div>
  );
}
